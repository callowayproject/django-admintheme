...
var DateTimeShortcuts = {
    ...
    addClock: function(inp) {
        ...
        clock_link.appendChild(document.createTextNode("Clock\240"));
        quickElement('span', clock_link, '\uf0d7', 'class', 'fontawesome', 'title', gettext('Show clock menu'));
    ...
    addCalendar: function(inp) {
        ...
        cal_link.appendChild(document.createTextNode("Calendar\240"));
        quickElement('span', cal_link, '\uf0d7', 'class', 'fontawesome', 'title', gettext('Show calendar'));
        shortcuts_span.appendChild(document.createTextNode('\240'));
